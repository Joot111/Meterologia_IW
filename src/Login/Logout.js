   ...
   useEffect(() => {
    ...
    const logoutAndClearData = async () => {
      ...
      try {
        ...
        //const response = await fetch('https://api.sheety.co/272ea837f9f1630e722be20ebe12f7b3/login/login/2', { -- original
        const response = await fetch('https://api.sheety.co/143d3a99cbe53d62a0cc649674db7d79/login/login/2', { //-- substituto
          method: 'DELETE',
          headers: {
