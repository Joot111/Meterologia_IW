...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://api.sheety.co/272ea837f9f1630e722be20ebe12f7b3/register/register`)
      ...
      .then((data) => {
        ...
        // Se o email não estiver registrado, prossegue com o registro
          ...
          //fetch("https://api.sheety.co/272ea837f9f1630e722be20ebe12f7b3/register/register", { -- original
          fetch("https://api.sheety.co/143d3a99cbe53d62a0cc649674db7d79/register/register", { //-- substituto
            method: "POST",
